...
const options = {
  key: FileSystem.readFileSync(path.join(_dirname,'SSL/key.pem')),
  cert: FileSystem.readFileSync(path.join(_dirname,'SSL/csr.pem'))
}
...
/*
  const options = {
  key: FileSystem.readFileSync(path.join(_dirname,'SSL/key.pem')),
  cert: FileSystem.readFileSync(path.join(_dirname,'SSL/cert.pem'))
 }
 */
